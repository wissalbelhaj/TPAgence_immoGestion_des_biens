    ...
    <nav class="navbar navbar-expand-lg" style="padding-left: 20px;background-color: rgb(8, 110, 150);">
      ...
      <div class="container mt-5">
            <div class="d-flex justify-content-center">
                <div>
                    <h1>Editer Option </h1>
                    <form action="{{ route('Admin.ModifierOption',$option->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <table class="mt-3">
                        <tr>
                            <td>
                                <label for="nom">Le Nom De option</label><br>
                                <input type="text" name="nom" id="nom" style="width: 400px" value="{{ $option->nom }}">
                            </td>
                            </tr>
                            <tr>
                                <td colspan="3"><input type="submit" value="Modifier" class="stylish-button mt-3" class="mt-3"></td>
                            </tr>
                    </table>
                </form>
                </div>
